...
if($action=="edit" && $id)
{
	$detail=$data->getData($con, "a.id, a.name, a.latitude, a.longitude, a.population, a.boundary_coordinates, a.district_id, a.status", "$table1 a", array("id"=>$id), "");
	$dtl=$detail['detail'];
}
?>							
	<script>
	$(document).ready(function(){
		...
		$("form#form").submit(function(){
			...
			<div class="well">
				<h3 class="col-sm-10"><?php echo ucfirst($page); ?> Form</h3>
				...
				<form method="POST" class="form-horizontal" role="form" id="form" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class='form-control' name="role" id="role" value="<?php echo $dtl[0]['role']; ?>" >
						</div>
					</div>
